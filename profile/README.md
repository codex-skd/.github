# <img alt="Codex SKD" src="https://codex.skdragons.com/images/logo.png" height="48"> Codex — Stalking Dragons
...
| **Almanac Core** | 📚 Library | **1.21.1** `0.0.0-beta.2` 🚧 | [Almanac Core](https://github.com/codex-skd/almanac-core) | [Almanac Core](https://www.curseforge.com/minecraft/mc-mods/almanac-core) |
...
| **Astral Core** | 📚 Library | **1.21.1** `0.0.0-beta.1` 🚧 | [Astral Core](https://github.com/codex-skd/astral-core) | [Astral Core](https://www.curseforge.com/minecraft/mc-mods/astral-core) |
...
| **Chain Crafter** | 🔧 Utility | **1.21.1** `0.0.0-beta.3` 🚧 | [Chain Crafter](https://github.com/codex-skd/chain-craftter) | [Chain Crafter](https://www.curseforge.com/minecraft/mc-mods/chain-crafter) |
...
| **Expedition Core** | 📚 Library | **1.21.1** `0.0.0-beta.2` 🚧 | [Expedition Core](https://github.com/codex-skd/expedition-core) | [Expedition Core](https://www.curseforge.com/minecraft/mc-mods/expedition-core) |
| **Frames Map 3D** | 🎨 Cosmetic | **1.21.1** `1.0.10` ✅ | [Frames Map 3D](https://github.com/codex-skd/frames-map-3d) | [Frames Map 3D](https://www.curseforge.com/minecraft/mc-mods/frames-map-3d) |
...
| **Majestic** | 🎮 Mechanics | **1.21.1** `0.0.0-beta.1` 🚧 | [Majestic](https://github.com/codex-skd/majestic) | [Majestic](https://www.curseforge.com/minecraft/mc-mods/majestic) |
| **Motorcade** | 🎮 Mechanics | **1.21.1** `0.0.0-beta.1` 🚧 | [Motorcade](https://github.com/codex-skd/motorcade) | [Motorcade](https://www.curseforge.com/minecraft/mc-mods/motorcade) |
| **Mystical Realms Modpack Fixes** | 🔧 Utility | **1.21.1** `1.2.1` ✅ | [Mystical Realms Modpack Fixes](https://github.com/codex-skd/mystical-realms-modpack-fixes) | [Mystical Realms Modpack Fixes](https://www.curseforge.com/minecraft/mc-mods/mystical-realms-modpack-fixes) |
...
| **Storage Bridge** | 🔧 Utility | **1.21.1** `1.0.0` ✅ | [Storage Bridge](https://github.com/codex-skd/storage-bridge) | [Storage Bridge](https://www.curseforge.com/minecraft/mc-mods/storage-bridge) |
...
| **Utility Core Admin** | 📚 Library | **26.1.2** `1.11.2` ✅ (legacy build)<br>**26.2** `2.4.0` ✅ | [Utility Core](https://github.com/codex-skd/utility-core) | [Utility Core Admin](https://www.curseforge.com/minecraft/mc-mods/utility-core-admin) |
| **Utility Core Fixes** | 📚 Library | **26.2** `2.5.1` ✅ | [Utility Core](https://github.com/codex-skd/utility-core) | [Utility Core Fixes](https://www.curseforge.com/minecraft/mc-mods/utility-core-fixes) |
| **Utility Core HUD** | 📚 Library | **26.2** `1.1.0` ✅ | [Utility Core](https://github.com/codex-skd/utility-core) | [Utility Core HUD](https://www.curseforge.com/minecraft/mc-mods/utility-core-hud) |
| **Utility Core QoL** | 📚 Library | **26.2** `2.4.0` ✅ | [Utility Core](https://github.com/codex-skd/utility-core) | [Utility Core QoL](https://www.curseforge.com/minecraft/mc-mods/utility-core-qol) |
...
> **Versions** are shown per Minecraft target directly, e.g. `**26.2** 1.1.0 ✅` — no need to decode any ordering. ✅ = stable release, 🚧 = beta/pre-release. `Utility Core Admin/Fixes/HUD/QoL` are 4 independent CurseForge projects sharing one GitHub repo (`utility-core`); `Admin` also carries the legacy single-mod 26.1.2 build.
>
...
>
> Regenerated 2026-09-23 from the live catalog (`codex/src/content/mods` + CurseForge API) — see `codex-docs/github-profile/profile/README.md`.
