...
>
> **GitHub `_pending_`**: no public mirror published yet (early-alpha, GitLab-only for now) — CurseForge link is the only public one. Retired projects (license/port audit, 2026-09-03): Ascendant Attributes/Enchanting/Equipment/Spawners, Cataclysm Bosses, Dinamyc Combat, Nautilus API, Player Animation Core, Slaughter Hide.
